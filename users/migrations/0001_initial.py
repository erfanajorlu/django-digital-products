    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='required 30 characters or fewer starting with a letter or Letters ,digit and etc', max_length=32, unique=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z][a-zA-Z0-9_\\.]+$', 'enter a valid username starting with a-z ')], verbose_name='username')),
                ('first_name', models.CharField(blank=True, max_length=30, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=30, verbose_name='last name')),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True, verbose_name='email address')),
                ('phone_number', models.BigIntegerField(blank=True, error_messages={'unique': 'A user with this phone number is already exists.'}, null=True, unique=True, validators=[django.core.validators.RegexValidator('^989[0-3 , 9]\\d{8}$', 'enter a valid phone number.')], verbose_name='mobile number')),
                ('is_staff', models.BooleanField(default=False, help_text='Designets whether the user can log into this admuin site.', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text='Designets whether this user should be treated as active.', verbose_name='active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.ForeignKey(default='Man', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='users.province', verbose_name='province')),
